    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="tips">
        <span style="margin-right:20px;">
          <change-lang :iconStyle="{color:'#889aa4',fontSize:'16px'}" @on-change="handleChangeLang"/>
        </span>
        <span>
          <change-template :iconStyle="{color:'#889aa4',fontSize:'16px'}" @on-change="handleChangeTemplate"/>
        </span>
      </div>
    </el-form>
  </div>
